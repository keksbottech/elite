...
<div className='flex items-center flex-wrap justify-center space-x-4 mt-5'>
        {
            ...
            <ProductCard key={featured.id} reviewStyle='bg-black dark:bg-accent' url={featured.image} title={featured.title} className='mb-5' subTitle={featured.description} review={featured.rating} tag={featured.tag} price={`$${featured.price}`} reviewStar={<IconStarFilled size={15} className='text-orange-400'/>} 
            circleTags={
